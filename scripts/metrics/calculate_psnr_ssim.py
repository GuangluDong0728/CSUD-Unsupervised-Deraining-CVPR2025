...
if __name__ == '__main__':
    ...
    parser.add_argument('--gt', type=str, default='/root/autodl-tmp/unsupervised deraining/datasets/rebuttal/test/gt', help='Path to gt (Ground-Truth)')
    parser.add_argument('--restored', type=str, default='/root/autodl-tmp/unsupervised deraining/datasets/rebuttal/test/input', help='Path to restored images')
